    ...
    try {
      ...
      if (!deploymentAllowed) {
        throw new OrchestratorError(
          ...
          ['Review contract security requirements', 'Address audit findings', 'Resubmit for re-audit'],
      ...
      throw new OrchestratorError(
        ...
        'AUDIT_SYSTEM_ERROR',
        ['Check audit system connectivity', 'Verify contract format', 'Contact security team'],
