...
(0, vitest_1.describe)('Schema Validation Integration Tests', () => {
    (0, vitest_1.describe)('Individual Agent Contract Validation', () => {
        (0, vitest_1.it)('should validate a complete, correct agent contract', () => {
            const validContract = {
            ...
            const result = schemas_1.AgentSchema.safeParse(validContract);
            (0, vitest_1.expect)(result.success).toBe(true);
            (0, vitest_1.expect)(result.data.enhancement_area).toBe("test-agent");
        });
        (0, vitest_1.it)('should reject contracts with missing required fields', () => {
            ...
            const result = schemas_1.AgentSchema.safeParse(invalidContract);
            (0, vitest_1.expect)(result.success).toBe(false);
            (0, vitest_1.expect)(result.error?.issues.some(issue => issue.path.includes('enhancement_area'))).toBe(true);
        });
        (0, vitest_1.it)('should reject contracts with invalid field lengths', () => {
            const invalidContract = {
                enhancement_area: "test-agent",
        ...
        (0, vitest_1.it)('should validate contracts with complex dependency relationships', () => {
            const contracts = [
                {
            ...
            const result = schemas_1.AgentArraySchema.safeParse(contracts);
            (0, vitest_1.expect)(result.success).toBe(true);
            (0, vitest_1.expect)(result.data).toHaveLength(2);
        });
        (0, vitest_1.it)('should reject contracts with circular dependencies', () => {
            ...
            const result = schemas_1.AgentArraySchema.safeParse(circularContracts);
            (0, vitest_1.expect)(result.success).toBe(false);
            (0, vitest_1.expect)(result.error?.message).toContain('Invalid dependency');
        });
        (0, vitest_1.it)('should validate contracts with maximum allowed modules', () => {
            ...
            const result = schemas_1.AgentSchema.safeParse(maxModulesContract);
            (0, vitest_1.expect)(result.success).toBe(true);
        });
        (0, vitest_1.it)('should reject contracts exceeding maximum modules', () => {
            ...
            const result = schemas_1.AgentSchema.safeParse(tooManyModulesContract);
            (0, vitest_1.expect)(result.success).toBe(false);
        });
    });
    (0, vitest_1.describe)('Batch Contract Validation', () => {
        (0, vitest_1.it)('should validate arrays of mixed valid and invalid contracts', () => {
            ...
            const result = schemas_1.AgentArraySchema.safeParse(mixedContracts);
            (0, vitest_1.expect)(result.success).toBe(false); // Should fail due to invalid contract
        });
        (0, vitest_1.it)('should handle empty contract arrays', () => {
            const result = schemas_1.AgentArraySchema.safeParse([]);
            (0, vitest_1.expect)(result.success).toBe(true);
            (0, vitest_1.expect)(result.data).toHaveLength(0);
        });
    });
    (0, vitest_1.describe)('Schema Evolution and Backwards Compatibility', () => {
        (0, vitest_1.it)('should maintain backwards compatibility with previous schema versions', () => {
            ...
            const result = schemas_1.AgentSchema.safeParse(legacyContract);
            (0, vitest_1.expect)(result.success).toBe(true);
        });
    });
});
